...
export default class EnterpriseApply extends Component{
    constructor(props){
        super(props);
        this.state = {
            areaValue:['请选择'],
    ...
    onButtonPress(){
        ...
        StorageUtil.get("auth").then((value) => {
            ...
            formData.append('industry', this.state.industryValue);
            formData.append('merchantType', '2');
        ...
        return (
                <View>
                    ...
                    <ScrollView style={[styles.scrollView, styles.horizontalScrollView]}>
                        ...
                        {/**/}
                        <TouchableOpacity
                            onPress={() => this._onPressBtn('BusinessLicense')}
                        >
                        <View style={[styles.userItem]}>
                        ...
                        {/**/}
                        <TouchableOpacity
                            onPress={() => this._onPressBtn('EnterpriseIdCardInfo')}
                        >
                            <View style={[styles.userItem]}>
                                <Text style={{color:'#333',fontSize:scaleSize(28),}}>企业法人身份证照片</Text>
                                <View style={styles.nextContain}>
                                    <Text style={{color:'#666',fontSize:scaleSize(24),marginRight:scaleSize(10)}}>上传成功</Text>
                                    <Image style={styles.nextIcon} source={require('../../../res/images/message/message_06.png')} />
                                </View>
                        ...
                        <TouchableOpacity
                            onPress={() => this._onPressBtn('OpenLicense')}
                        >
                            <View style={[styles.userItem]}>
                                <Text style={{color:'#333',fontSize:scaleSize(28),}}>开户许可证</Text>
                                <View style={styles.nextContain}>
                                    <Text style={{color:'#666',fontSize:scaleSize(24),marginRight:scaleSize(10)}}>上传成功</Text>
                                    <Image style={styles.nextIcon} source={require('../../../res/images/message/message_06.png')} />
                                </View>
                        ...
                        <TouchableOpacity
                            onPress={() => this._onPressBtn('EnterpriseBankInfo')}
                        >
                            <View style={[styles.userItem]}>
                                <Text style={{color:'#333',fontSize:scaleSize(28),}}>银行卡信息</Text>
                                <View style={styles.nextContain}>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={this.onButtonPress.bind(this)} style={{marginTop:scaleSize(50),}}>
                            <View style={{ width:width,
                                ...
                                <View style={styles.btn}>
                                    <Text style={{color: '#fff', fontSize: scaleSize(32),textAlign:'center',lineHeight:scaleSize(70)}}>提交审核</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    </ScrollView>

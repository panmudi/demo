           ...
           >
               <View  style={styles.container}>
                   ...
                   <View style={styles.jjArea}>
                       ...
                       <Text  style={[styles.jjT1,styles.mb20]}>您的进件审核失败</Text>
                       <TouchableOpacity>
                       ...
                       <View style={{alignItems:'flex-start'}}>
                           <Text  style={[styles.jjT1]}>审核失败原因：</Text>
                           <Text  style={[styles.jjT1]}>1.您的营业执照照片未上传</Text>
                           <Text  style={[styles.jjT1]}>2.您的支付宝账号未填写</Text>
                       </View>
                       {/**/}
                   </View>
                   {/**/}
